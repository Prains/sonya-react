        ...
        <section className="main">
            ...
            <div className='main__image'>
                ...
                <div className='main__image__advantages'>
                    <p className='main__image__advantages__advantage'><img src={star} alt="" />Дизайн страниц</p>
                    <p className='main__image__advantages__advantage'><img src={man} alt="" />Лендинги</p>
                    <p className='main__image__advantages__advantage'><img src={cart} alt="" />Интернет-магазины</p>
                    <p className='main__image__advantages__advantage'><img src={web} alt="" />Многостраничники</p>
                </div>
